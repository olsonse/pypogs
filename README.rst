...
+ Mounts supported through the Instrument Neutral Distributed Interface (INDI)
    - indi_simulator_telescope (tested)
    - Others will certainly need some testing
...
+ Cameras supported through the Instrument Neutral Distributed Interface (INDI)
    - indi_simulator_ccd (tested)
    - Others will certainly need some testing
